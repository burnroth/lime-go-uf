      ...
      <div className="container">
        <div className="row">
          <div style={{
            ...
            <h1 style={{
              marginBottom: 60,
            }} >Maximera ditt UF-år med Lime Go</h1>
            <p>
          ...
          <div className="col-12 col-md-6">
            ...
            <p>
              ...
              ganska snart märka att det tar mycket tid. <br />
              <br /> I Lime Go kan du enkelt filtrera fram potentiella kunder
              och{" "}
          ...
          <div className="col-12 col-md-6">
            ...
            <p>
              ...
              inte ska gå förlorad. <br />I Lime Go kan du spara{" "}
          ...
          <div className="col-12 col-md-6">
            <h3>Försvinn inte i mängden/Förlora färre affärer</h3>
            <p>
              ...
              <br />I Lime Go samlar du all affärsinformation på ett ställe och
              kan <a href="https://www.youtube.com/watch?v=fTsGkf1dAaI">ställa in påminnelser och göra mötesbokningar</a>.
            </p>
          </div>
          <div className="col-12 col-md-6">
            <h3>Exempel: 5 säljscenarier</h3>
            <p>
              I vår jämförelse <a href="https://lime-go.se/med-vs-utan-saljverktyg/">”Med vs. utan säljverktyg”</a>  har vi listat fem
              säljscenarier för att visa hur Lime Go kan hjälpa till i din
              vardag.
            </p>
          </div>
        </div>
